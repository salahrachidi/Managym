    ...
    <form action="/machines" method="POST" enctype="multipart/form-data">
        ...
        <div class="input-group mb-4">
            ...
            <input type="text" class="form-control @error('mac_label') is-invalid @enderror" name="mac_label"
                value="{{ old('mac_label') }}" placeholder="libelle">
            @error('mac_label')
        ...
        <div class="input-group mb-4">
            ...
            <input type="text" class="form-control @error('mac_description') is-invalid @enderror" name="mac_description"
                value="{{ old('mac_description') }}" placeholder="description">
        ...
        <div class="input-group mb-4">
            ...
            <input type="text" class="form-control @error('mac_matricule') is-invalid @enderror" name="mac_matricule"
                value="{{ old('mac_matricule') }}" placeholder="matricule">
            @error('mac_matricule')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
