    ...
    <main class="main">
            ...
            <div class="home__container container grid">
                <div class="home__data">
                    ...
                    <p class="home__description">
                        ...
                        ideal body and live your life to the fullest.
                    </p>
                    <a href="/home/login" class="button button__flex">
                        Get Started<i class="ri-arrow-right-line"></i>
                    </a>
                </div>
                <div class="home__images">
                    <img src="{{ asset('images/HomePage/home-img2.png') }}" alt="home__image" class="home__img">
        ...
        <!-- <section class="logos section">
            <div class="logos__container container grid">
                <img src="{{ asset('images/HomePage/logo1.png') }}" alt="logo img" class="logos__img">
                <img src="{{ asset('images/HomePage/logo2.png') }}" alt="logo img" class="logos__img">
                <img src="{{ asset('images/HomePage/logo3.png') }}" alt="logo img" class="logos__img">
                <img src="{{ asset('images/HomePage/logo4.png') }}" alt="logo img" class="logos__img">
            </div>
        </section> -->
                ...
                <div class="program__container grid">
                    <article class="program__card">
                        <div class="program__shape">
                            <img src="{{ asset('images/HomePage/program1.png') }}" alt="program img"
                                class="program__img">
                        </div>
                    ...
                    <article class="program__card">
                        <div class="program__shape">
                            <img src="{{ asset('images/HomePage/program2.png') }}" alt="program img"
                                class="program__img">
                        </div>
                    ...
                    <article class="program__card">
                        <div class="program__shape">
                            <img src="{{ asset('images/HomePage/program3.png') }}" alt="program img"
                                class="program__img">
                        </div>
                    ...
                    <article class="program__card">
                        <div class="program__shape">
                            <img src="{{ asset('images/HomePage/program4.png') }}" alt="program img"
                                class="program__img">
                        </div>
            ...
            <div class="choose__overflow">
                <div class="choose__container container grid">
                    ...
                    <div class="choose__image">
                        <img src="{{ asset('images/HomePage/choose-img.png') }}" alt="choose img"
                            class="choose__img">
            ...
            <div class="container">
                ...
                <div class="pricing__container grid">
                    <article class="pricing__card">
                        <header class="pricing__header">
                            <div class="pricing__shape">
                                <img src="{{ asset('images/HomePage/pricing1.png') }}" alt="pricing img"
                                    class="pricing__img">
                            </div>
                    ...
                    <article class="pricing__card pricing__card-active">
                        <header class="pricing__header">
                            <div class="pricing__shape">
                                <img src="{{ asset('images/HomePage/pricing2.png') }}" alt="pricing img"
                                    class="pricing__img">
                            </div>
                        ...
                        <ul class="pricing__list">
                            ...
                            <li class="pricing__item">
                                <i class="ri-checkbox-circle-line pricing__item-opacity"></i> Access to Videos
                            </li>
                            <li class="pricing__item">
                                <i class="ri-checkbox-circle-line pricing__item-opacity"></i> Muscle Stretching
                            </li>
                        </ul>
                        <a href="#" class="button button__flex pricing__button">
                            Purchase Now <i class="ri-arrow-right-line"></i>
                    ...
                    <article class="pricing__card">
                        <header class="pricing__header">
                            <div class="pricing__shape">
                                <img src="{{ asset('images/HomePage/pricing3.png') }}" alt="pricing img"
                                    class="pricing__img">
                            </div>
